...
# Router lives in bot_router (kept separate from handlers). Imported lazily
# inside main() to avoid a circular import (bot_router imports handler names
...
def main():
    ...
    from bot_router import callback_router

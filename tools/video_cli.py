...
# Add the repository root to sys.path so `config` and `core.*` import correctly
# when this script lives in tools/.
...
from core.video import _out_filename as get_video_filename
